...
See the [PostgreSQL K8s how-to enable TLS](https://canonical.com/data/postgresql/docs/16/how-to/network-and-encryption/enable-tls/)
...
[charm configuration option](https://charmhub.io/spark-history-server-k8s/configurations?channel=4/edge).

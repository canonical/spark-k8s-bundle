...
The PostgreSQL charm supports the creation of a backup to an S3 compliant object storage. Please refer to [PostgreSQL documentation](https://canonical.com/data/postgresql/docs/14/how-to/back-up-and-restore/) to check the available options and more details.

...
| integration_hub_monitored_service_accounts | Comma-separated patterns for namespaces and service accounts to monitor [...]   | string | True     | null                |
...
| spark         | kyuubi-k8s                   | 3.4/stable    | 140      |

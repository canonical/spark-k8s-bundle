...
| 2     | h-history-server-authorisation | [Enable Authorisation History Server](/t/charmed-spark-k8s-documentation-how-to-enable-authentication-on-the-spark-history-server-charm/13563) |
